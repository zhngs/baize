...
void log_print()
{
    ...
    while (1) {
        ...
        double write_bytes = static_cast<double>(g_writtenbytes - g_writtenbytes_last);
...
int main()
{
    ...
    while (1) {
        ...
        // LOG_INFO << "h" << "e" << "l" << "l" << "o"
        //          << "h" << "e" << "l" << "l" << "o";
        LOG_INFO << "hellohellohellohellohellohellohellohellohellohellohellohello";

        // LOG_INFO << "AsyncLogging start AsyncLogging start AsyncLogging start";
    }
}