...
public:
    ...
    ~Impl() { LOG_TRACE << "routine" << routineid_ << " destory"; }
...
runtime::Routine::Routine(RoutineCallBack func)
  : impl_(std::make_unique<Impl>(func)), timeout_(10)
{
}
...
uint64_t runtime::Routine::getCurrentRoutineId() { return g_currentRoutineId; }

uint64_t runtime::Routine::getRoutineId() { return impl_->getRoutineId(); }
